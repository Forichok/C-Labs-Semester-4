    ...
    class Program
        {
            ...
            static decimal SumE(int k) => (decimal)(Math.Pow(1, k) / Factorial(k));
            ...
            {
                Console.WriteLine("e = {0:E15}",FuncE1());
                Console.WriteLine("e = {0:E15}",FuncE2());
                Console.WriteLine("Pi = {0:E15}",FuncPi1());
                Console.WriteLine("Pi = {0:E15}",FuncPi2());
                Console.WriteLine("ln2 = {0:E15}",FuncLn1());
                Console.WriteLine("ln2 = {0:E15}",FuncLn2());
                Console.WriteLine("sqrt(2) = {0:E15}",FuncSqrt1());
                Console.WriteLine("sqrt(2) = {0:E15}", FuncSqrt2());
                Console.WriteLine("g = {0:E15}",FuncG1());
                Console.WriteLine("g = {0:E15}", FuncG2());
            Console.ReadKey();
            }
        }
